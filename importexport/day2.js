...
let A = movies.filter(function (el) {
  return Number(el.Year) > 2009
})
console.log(A)


let B = movies.filter(function (el) {
  return Number(el.Year) == 2009
})
console.log(B)


let C = movies.filter(function (el) {
  return Number(el.Year) != 2009
})
console.log(C)
...
let numbers = [33,44,5,66,77,33,455,-55]
let D = numbers.sort()
console.log(D)
console.log(numbers)
